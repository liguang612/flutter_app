...
enum IndicatorStyle {
  ...
  /// Draw dot with number indicator.
  numberDot,
}
...
class TimelineTileBuilder {
  ...
  factory TimelineTileBuilder.connectedFromStyle({
    ...
    return TimelineTileBuilder(
      ...
      indicatorBuilder: (context, index) => _createStyledIndicatorBuilder(
          indicatorStyleBuilder?.call(context, index), index)(context),
      startConnectorBuilder: _createConnectedStartConnectorBuilder(
        connectionDirection: connectionDirection,
  ...
  factory TimelineTileBuilder.fromStyle({
    ...
    return TimelineTileBuilder(
      ...
      indicatorBuilder: (context, index) =>
          _createStyledIndicatorBuilder(indicatorStyle, index)(context),
  ...
  static WidgetBuilder _createStyledIndicatorBuilder(
      IndicatorStyle? style, int? number) {
    return (_) {
      switch (style) {
        ...
        case IndicatorStyle.numberDot:
          return Indicator.numberDot(
            number: number,
          );
